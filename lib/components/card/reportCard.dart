...
class ReportCard extends StatefulWidget {
  ...
  final int? status;
  ReportCard({Key? key, this.reportInfo, this.status}) : super(key: key);

  @override
  State<StatefulWidget> createState() => ReportCardState();
}
                    ...
                    child: Column(
                      children: [
                        for (var item in _itemList!)
                          _detaiItem(item['title'] ?? '匿名', item['introduction'] ?? '')
                      ],
                    ),
                  ),
                ],
    ...
    return Row(
      children: [
        Expanded(
          ...
          '【$title】:  $introduction',
          style: TextStyle(
              fontSize: 14.sp, color: StyleTheme.cTitleColor, height: 1.5.w),
          maxLines: 1,
