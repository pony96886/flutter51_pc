...
class MineMemberPage extends StatefulWidget {
  const MineMemberPage({Key? key}) : super(key: key);

  @override
  State<MineMemberPage> createState() => _MineMemberPageState();
}

class _MineMemberPageState extends State<MineMemberPage> with PayMixin {
  bool loading = true;
  List productList = [];
  ...
  void initState() {
    ...
    super.initState();
    vipUpgrade = Provider.of<HomeConfig>(context, listen: false).member.vipUpgrade;
    getProducList();
  }
            ...
            children: [
                      ...
                      child: Row(
                        children: [
                          ...
                          Expanded(
                              child: new Marquee(
                            text: rechargeTips,
                            style: new TextStyle(color: Color(0xFFf3f3f4), fontSize: 11.sp),
              ...
              Expanded(
                  child: loading
                      ...
                      : ListView(
                          padding: EdgeInsets.symmetric(vertical: 16.w, horizontal: 0),
                          children: [
                            vipUpgrade!
                                ? Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Container(
                                          width: 315.5.w,
                                          height: 150.w,
                                          margin: EdgeInsets.only(top: 17.w, bottom: 28.w),
                                          child: ImageNetTool(
                                            url: myCard['bg_url'],
                                          ),
                                        ),
                              ...
                              child: Swiper(
                                itemBuilder: (BuildContext context, int index) {
                                  return Container(
                                    ...
                                    child: ImageNetTool(url: productList[index]['bg_url'], fit: BoxFit.fill),
                                  );
                                },
                                loop: true,
                            ...
                            ValueListenableBuilder(
                                ...
                                builder: (context, int? index, Widget? child) {
                                  return productList[index!]['description'].isEmpty
                                      ? SizedBox()
                                      : Padding(
                                          padding: EdgeInsets.only(left: 42.5.w, right: 42.5.w, top: 12.w),
                                          child: Text(
                                            productList[index]['description'],
                                            textAlign: TextAlign.center,
                                            style: TextStyle(fontSize: 12.sp, color: Color(0xff0e0e0e)),
                                          ),
                                        );
                                }),
                            Padding(
                              padding: EdgeInsets.symmetric(horizontal: 28.5.w, vertical: 16.5.w),
                              child: Column(
                                children: [
                                  LocalPNG(
                                  ...
                                  ValueListenableBuilder(
                                    ...
                                    builder: (context, int i, child) {
                                      List right = productList[i]['right'] ?? [];
                                          ...
                                          itemBuilder: (context, index) {
                                            return Column(
                                              ...
                                              children: [
                                                ...
                                                Text(right[index]['desc'].toString(),
                                                    textAlign: TextAlign.center,
                                                    style: TextStyle(
                  ...
                  : ValueListenableBuilder(
                      ...
                      builder: (context, int value, child) {
                        return GestureDetector(
                          onTap: () {
                            if (vipUpgrade!) {
                              if (money < double.parse('${productList[value]['upgrade_price']}')) {
                                CgDialog.cgShowDialog(context, '温馨提示', '元宝金额不足，是否立即充值', ['取消', '立即充值'], callBack: () {
                                  AppGlobal.appRouter?.push(CommonUtils.getRealHash('ingotWallet'));
                                });
                                return;
                              }
                              CgDialog.cgShowDialog(context, '温馨提示', '', ['取消', '确认'],
                                  contentWidget: Padding(
                                    ...
                                    child: Text.rich(
                                      TextSpan(children: [
                                        ...
                                        TextSpan(
                                            text: productList[value]['upgrade_price'],
                                ...
                                vipUpgradePay(productList[value]['id']).then((res) {
                                  if (res!['status'] != 0) {
                                    CgDialog.cgShowDialog(context, '升级成功', '', ['确定'],
                                        contentWidget: Padding(
                                          padding: EdgeInsets.only(top: 15.w),
                                          child: Text.rich(
                                            TextSpan(children: [
