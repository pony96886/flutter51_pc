...
class MineCardpackPage extends StatefulWidget {
  MineCardpackPage({Key? key}) : super(key: key);

  @override
  _MineCardpackPageState createState() => _MineCardpackPageState();
}

class _MineCardpackPageState extends State<MineCardpackPage> with TickerProviderStateMixin {
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text(
            '还没有优惠券呢',
            style: TextStyle(fontSize: 14.sp, color: StyleTheme.cBioColor, height: 2),
          ),
          Text(
            '雅间预约妹子成功',
            style: TextStyle(fontSize: 12.sp, color: StyleTheme.cDangerColor, height: 2),
          ),
          Text(
            '并进行评价即可获得元宝优惠券',
            style: TextStyle(fontSize: 12.sp, color: StyleTheme.cDangerColor, height: 2),
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              child: Stack(
                children: [
                  LocalPNG(height: 50.w, width: 275.w, url: 'assets/images/mymony/money-img.png', fit: BoxFit.cover),
                  Center(
                    child: Text(
                      '前往预约',
