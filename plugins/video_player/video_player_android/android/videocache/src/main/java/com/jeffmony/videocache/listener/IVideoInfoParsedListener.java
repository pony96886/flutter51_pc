...
public interface IVideoInfoParsedListener {
    ...
    //M3U8视频解析成功
    void onM3U8ParsedFinished(VideoRequest videoRequest, M3U8 m3u8, VideoCacheInfo cacheInfo);
    ...
    //非M3U8视频解析成功
    void onNonM3U8ParsedFinished(VideoRequest videoRequest, VideoCacheInfo cacheInfo);
