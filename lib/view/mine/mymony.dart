...
class MyMonyPage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => MyMonyPageState();
}

class MyMonyPageState extends State<MyMonyPage> {
  void _onGotoPublish() {
                  ...
                  children: [
                    ...
                    Container(
                      padding: new EdgeInsets.only(
                          top: 20.w, left: 15.5.w, right: 15.5.w),
                      child: Column(
                        children: [
                          Container(
                            child: Column(
                              ...
                              children: [
                                ...
                                _menuItem(
                                    'assets/images/mymony/promote.png', '推广赚铜钱',
                                    () {
                                  AppGlobal.appRouter?.push(
                                      CommonUtils.getRealHash(
                                          'shareQRCodePage'));
                                }, true),
                                _menuItem('assets/images/mymony/sign_in.png',
                                    '每日签到得铜钱', () {
                                  BotToast.showText(
                                      text: '完成首页萌新15天签到活动可以获得大量铜钱',
                                      align: Alignment.center);
                                }, false),
                                _menuItem(
                                    'assets/images/mymony/verification.png',
                                    '发布茶帖赚铜钱', () {
                                  BotToast.showText(
                                      text: '发布茶帖赚铜钱', align: Alignment.center);
                                }, false),
                                _menuItem(
                                    'assets/images/mymony/unlock_report.png',
                                    '发布验茶报告赚铜钱', () {
                                  BotToast.showText(
                                      text: '发布验茶报告,用户解锁赚铜钱',
                                      align: Alignment.center);
                                ...
                                _menuItem(
                                    'assets/images/mymony/order_comment.png',
                                    '对已完成的预约单进行评论获得铜钱', () {
                                  BotToast.showText(
                                      text: '对已完成的预约单进行评论获得铜钱',
                                      align: Alignment.center);
                                }, false),
                              ],
                            ),
                    ...
                    Container(
                      ...
                      padding: new EdgeInsets.only(
                          left: 15.w, right: 15.w, top: 30.w, bottom: 30.w),
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text(
          ...
          children: [
            ...
            Text(
              CommonUtils.renderFixedNumber(double.parse(
                  Provider.of<HomeConfig>(context).member.coins.toString())),
              style: TextStyle(
                  fontSize: 30.sp,
                  color: StyleTheme.cTitleColor,
                  fontWeight: FontWeight.w500),
            ...
            GestureDetector(
              onTap: () {
                AppGlobal.appRouter
                    ?.push(CommonUtils.getRealHash('monyDtailPage'));
              },
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                    ...
                    color: Color.fromRGBO(251, 240, 229, 1)),
                width: 60.w,
                height: 20.w,
...
Widget _menuItem(
    String img, String title, GestureTapCallback onTap, bool arrow) {
