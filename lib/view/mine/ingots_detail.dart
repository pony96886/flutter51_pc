...
class IngotsDetailPage extends StatefulWidget {
  IngotsDetailPage({Key? key}) : super(key: key);

  @override
  _IngotsDetailPageState createState() => _IngotsDetailPageState();
}

class _IngotsDetailPageState extends State<IngotsDetailPage>
                  ...
                  PageViewMixin(
                    child: PublicList(
                        ...
                        itemBuild:
                          ...
                          return withdrawItem(data['time'], data['source'],
                              data['coinCnt'].toString());
                        }),
                  ),
                  PageViewMixin(
                      child: PublicList(
