...
class Popularize extends StatefulWidget {
  Popularize({Key? key}) : super(key: key);

  @override
  _PopularizeState createState() => _PopularizeState();
}
                            ...
                            children: [
                              Container(
                                ...
                                padding: EdgeInsets.symmetric(
                                    vertical: 20.w, horizontal: 20.5.w),
                                  ...
                                  children: [
                                    ...
                                    Container(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            PopularizeNumber(
                                              numbers: proxyData!['invited_num']
                                                  .toString(),
                                              title: "成功邀请数",
                                            ),
                                            PopularizeNumber(
                                              numbers: proxyData!['money_num']
                                                  .toString(),
                                              title: "元宝收益",
                                            ),
                                            PopularizeNumber(
                                              numbers: proxyData!['coin_num']
                                                  .toString(),
                                              title: "铜钱收益",
                                            ),
                                            Column(
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        PopularizeMenu(
                                          icon:
                                              "assets/images/popularize/detial.png",
                                          title: "收益明细",
                                          onTap: () {
                                        ...
                                        PopularizeMenu(
                                          icon:
                                              "assets/images/popularize/withdraw.png",
                                          title: "去提现",
                                          onTap: () {
                                            AppGlobal.appRouter?.push(
                                                CommonUtils.getRealHash(
                                        ...
                                        PopularizeMenu(
                                          icon:
                                              "assets/images/popularize/record.png",
                                          title: "推广记录",
                                          onTap: () {
                                            AppGlobal.appRouter?.push(
                                                CommonUtils.getRealHash(
                                        ...
                                        PopularizeMenu(
                                          icon:
                                              "assets/images/popularize/to_popu.png",
                                          title: "去推广",
                                          onTap: () {
                                            AppGlobal.appRouter?.push(
                                                CommonUtils.getRealHash(
                              ...
                              Container(
                                margin:
                                    EdgeInsets.only(top: 30.w, bottom: 20.w),
                                height: 23.w,
                                child: LocalPNG(
                              ...
                              Container(
                                ...
                                child: LocalPNG(
                                  url:
                                      "assets/images/popularize/popularize1.png",
                                  height: 70.w,
                                ),
                              ),
                              Container(
                                ...
                                child: LocalPNG(
                                  url:
                                      "assets/images/popularize/popularize2.png",
                                  height: 70.w,
                                ),
                              ),
                              Container(
                                  ...
                                  child: LocalPNG(
                                    url:
                                        "assets/images/popularize/popularize3.png",
                                    height: 70.w,
                                  )),
                              Container(
                                  margin: EdgeInsets.only(bottom: 10.w),
                                  ...
                                  child: LocalPNG(
                                    url:
                                        "assets/images/popularize/popularize4.png",
                                    height: 70.w,
                                  )),
                              Container(
                                  margin: EdgeInsets.only(bottom: 10.w),
                                  ...
                                  child: LocalPNG(
                                    url:
                                        "assets/images/popularize/popularize5.png",
                                    height: 70.w,
                                  )),
                              Container(
                              ...
                              Container(
                                  ...
                                  child: LocalPNG(
                                    url:
                                        "assets/images/popularize/popularize-table.png",
                                    height: 70.w,
                                  )),
                            ],
                          )),
...
class PopularizeNumber extends StatelessWidget {
  ...
  final String? title;
  const PopularizeNumber({Key? key, this.numbers, this.title})
      : super(key: key);
...
class PopularizeMenu extends StatelessWidget {
  ...
  const PopularizeMenu({Key? key, this.icon, this.title, this.onTap})
      : super(key: key);
