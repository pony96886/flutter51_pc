...
class MineCardpackExchangeCouponPage extends StatefulWidget {
  MineCardpackExchangeCouponPage({Key? key}) : super(key: key);

  @override
  State<MineCardpackExchangeCouponPage> createState() => _MineCardpackExchangeCouponPageState();
}

class _MineCardpackExchangeCouponPageState extends State<MineCardpackExchangeCouponPage> {
  bool loading = true;
    ...
    return showModalBottomSheet(
        ...
        builder: (BuildContext context) {
          return StatefulBuilder(builder: (context, setBottomSheetState) {
            var coins = Provider.of<HomeConfig>(context, listen: false).member.coins;
            return Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    LocalPNG(
                                      width: 40.w,
                                      height: 40.w,
                                      url: 'assets/images/mine/wodetongqian.png',
                                      fit: BoxFit.contain,
                                    ),
                                    SizedBox(
                                      width: 11.w,
                                    ...
                                    Text.rich(TextSpan(
                                        text: product['exchange_price'].toString(),
                              ...
                              child: GestureDetector(
                                onTap: () {
                                  if (double.parse(coins.toString()) <
                                      (double.parse(product['exchange_price'].toString()))) {
  ...
  Widget build(BuildContext context) {
    return HeaderContainer(
      ...
      appBar: PreferredSize(child: PageTitleBar(title: '兑换优惠券'), preferredSize: Size(double.infinity, 44.w)),
      body: networkErr
          ? NetworkErr(
              errorRetry: () {
                getList();
                ...
                Center(
                  child: Padding(
                    ...
                    child: Text(
                      ...
                      style: TextStyle(color: Color(0xFF505050), fontSize: 20.sp, fontWeight: FontWeight.w500),
                    ),
                  ),
                ),
              ],
