...
class _MinePagesState extends State<MinePages> with TickerProviderStateMixin {
                ...
                Column(
                  ...
                  children: <Widget>[
                    ...
                    Text(
                      ...
                      style: TextStyle(
                          color: StyleTheme.cDangerColor, fontSize: 11.sp),
                    ),
                    Text(
          ...
          children: [
            ...
            Scaffold(
              ...
              appBar: PreferredSize(
                  child: TitleBar(opacityvalue: _headeropacity),
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            ...
                            MenuCard(
                              ...
                              title: "推广赚钱",
                              onTap: () {
                                if (Provider.of<HomeConfig>(context,
                                            listen: false)
                                  ...
                                  AppGlobal.appRouter?.push(
                                      CommonUtils.getRealHash('popularize'));
                                }
                              },
                            ),
                            MenuCard(
                      ...
                      child: Column(
                        children: <Widget>[
                          ListTileItem(
                            ...
                            onTap: () {
                              context
                                  .push(CommonUtils.getRealHash('videoWork'));
                            },
                          ),
                          ListTileItem(
                            ...
                            onTap: () {
                              AppGlobal.appRouter?.push(
                                  CommonUtils.getRealHash('youhuiquanCard'));
                            },
                            trailing: Container(
                          ...
                          ListTileItem(
                            ...
                            onTap: () {
                              context.push(
                                  CommonUtils.getRealHash('userMallOrder'));
                            },
                          ),
                          ListTileItem(
                            ...
                            onTap: () {
                              context
                                  .push(CommonUtils.getRealHash('myTeaPost/0'));
                            },
                            trailing: Container(
                              padding: EdgeInsets.only(right: 5.5.w),
                              child: Text(
                          ...
                          ListTileItem(
                            ...
                            onTap: () {
                              AppGlobal.appRouter?.push(
                                  CommonUtils.getRealHash('reservationPage'));
                            },
                            trailing: Container(
                              padding: EdgeInsets.only(right: 5.5.w),
                              child: Text(
                          ...
                          ListTileItem(
                            ...
                            onTap: () {
                              AppGlobal.appRouter?.push(
                                  CommonUtils.getRealHash('elegantCollect'));
                            },
                          ),
                          ListTileItem(
                            ...
                            onTap: () {
                              AppGlobal.appRouter
                                  ?.push(CommonUtils.getRealHash('myMonyPage'));
                            },
                            trailing: Container(
                              padding: EdgeInsets.only(right: 5.5.w),
                              child: Text(
                          ...
                          ListTileItem(
                            ...
                            title: "隐私保护",
                            onTap: () {
                              PersistentState.getState('initApp')
                                  .then((initapp) {
                                //第一次使用App
                                if (initapp == null) {
                                  AppGlobal.appRouter?.push(
                                      CommonUtils.getRealHash('tealist'));
                                } else {
                                  String oneStr = '1';
                                  String zeroStr = '0';
                                  PersistentState.saveState('isPrivacy',
                                      !_privacy ? oneStr : zeroStr);
                                  setState(() {
                                    _privacy = !_privacy;
                                  });
                                }
                          ...
                          ListTileItem(
                            ...
                            title: "官方开车群",
                            onTap: () {
                              var groupUrl = Provider.of<HomeConfig>(context,
                                      listen: false)
                                  .config
                                  .officialGroup;
                              if (groupUrl == "") {
                                BotToast.showText(
                                    text: '(URL NULL)', align: Alignment(0, 0));
                              } else {
  ...
  _vipWidget() {
    ...
    if (profile?['old_vip'] == 1) {
      ...
      if (profile?['expired_at'] == 0) {
        ...
        vipTag = '立即续费';
        var times = new DateTime.fromMillisecondsSinceEpoch(
            profile?['expired_at'] * 1000);
        ...
        builder: (ctx, state, child) => Container(
            ...
            child: Stack(
              children: [
                ...
                state.member.vipLevel == 4
                    ? LocalPNG(url: 'assets/images/common/vip5.png')
                    : SizedBox(),
              ],
            )));
  }
              ...
              onTap: () {
                if (state.member.oltime != 1) {
                  AppGlobal.appRouter?.push(CommonUtils.getRealHash('webview/' +
                      Uri.encodeComponent(UserInfo.wxykUrl!) +
                      '/' +
                      '无限悦帖'));
                }
              },
                ...
                Row(
                  ...
                  children: <Widget>[
                    GestureDetector(
                      onTap: () {
                        AppGlobal.appRouter
                            ?.push(CommonUtils.getRealHash('loginPage/2'));
                      },
                      child: Container(
                        color: Colors.transparent,
                        width: 120.w,
  ...
  Widget build(BuildContext context) {
    ...
    if (members.oldVip == 1) {
      ...
      if (members.expiredAt == 0) {
        ...
        var times =
            new DateTime.fromMillisecondsSinceEpoch(members.expiredAt! * 1000);
        texts = ' ${times.year}-${times.month}-${times.day} 到期';
      }
    }
    return Text(
...
class MenuCard extends StatelessWidget {
  ...
  const MenuCard({Key? key, this.image, this.title, this.onTap})
      : super(key: key);
