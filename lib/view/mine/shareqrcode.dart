...
class SharePageState extends State<ShareQRCodePage> {
  Config? _config;
                      ...
                      child: Row(
                        ...
                        children: [
                          GestureDetector(
                            onTap: _toBack,
                            child: LocalPNG(
                                url: 'assets/images/icon-back.png',
                                height: 25.w),
                          ),
                          GestureDetector(
                ...
                child: Column(
                  children: [
                    ...
                    Center(
                      child: Text(
                        '每成功邀请1名手机注册用户，获得 ' +
                            addCoinInvition.toString() +
                            ' 铜钱',
                        style: TextStyle(
                            color: Color(0xFFF9DC7A), fontSize: 14.sp),
                      ),
                    ),
                    Container(
                      ...
                      child: Row(
                          ...
                          children: [
                            GestureDetector(
                              ...
                              child: LocalPNG(
                                  url:
                                      'assets/images/share/share-botton-save.png',
                                  height: 50.w),
                            ),
                            GestureDetector(
                              ...
                              child: LocalPNG(
                                  url:
                                      'assets/images/share/share-botton-copy.png',
                                  height: 50.w),
                            ),
                          ]),
                    )
  ...
  void _copyLinkShare() {
    Clipboard.setData(ClipboardData(
        text:
            '请使用google浏览器或UC浏览器，如无法访问请翻墙|${_config!.share!.affUrlCopy!.url}'));
