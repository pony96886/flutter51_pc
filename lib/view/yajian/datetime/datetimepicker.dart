          ...
          return ClipRect(
            child: CustomSingleChildLayout(
              ...
              child: GestureDetector(
                child: Material(
                  color: theme.data.backgroundColor ?? Colors.white,
  ...
  Widget _renderColumnView(
    ...
    return Expanded(
      ...
      child: Container(
          ...
          height: 30.w,
          decoration:
              BoxDecoration(color: theme.data.backgroundColor ?? Colors.white),
          child: NotificationListener(
              ...
              child: CupertinoPicker.builder(
                  key: key,
                  backgroundColor: theme.data.backgroundColor ?? Colors.white,
  ...
  Widget _renderTitleActionsView(DatePickerTheme theme) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: theme.data.dividerColor ?? Colors.white,
      ),
      child: Row(
        mainAxisAlignment: MainAxisAlignment.spaceBetween,
        children: <Widget>[
          Container(
            ...
            child: CupertinoButton(
              ...
              child: Text(
                '$cancel',
                style: theme.data.cancelButtonStyle!.textStyle as TextStyle,
              ),
              onPressed: () {
          ...
          Container(
            ...
            child: CupertinoButton(
              ...
              child: Text(
                '$done',
                style: theme.data.confirmButtonStyle!.textStyle as TextStyle,
              ),
              onPressed: () {
