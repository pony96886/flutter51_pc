...
public class Messages {
  ...
  public static final class BrightnessMessage {
    ...
    private @NonNull Double brightness;

    public @NonNull Double getBrightness() {
      return brightness;
    }

    public void setBrightness(@NonNull Double setterArg) {
      if (setterArg == null) {
        throw new IllegalStateException("Nonnull field \"brightness\" is null.");
      }
      this.brightness = setterArg;
    }
    ...
    public static final class Builder {
      ...
      public @NonNull Builder setBrightness(@NonNull Double setterArg) {
        this.brightness = setterArg;
        return this;
      }
      ...
      public @NonNull BrightnessMessage build() {
        ...
        pigeonReturn.setTextureId(textureId);
        pigeonReturn.setBrightness(brightness);
        return pigeonReturn;
      }
    }
    ...
    static @NonNull BrightnessMessage fromList(@NonNull ArrayList<Object> list) {
      ...
      Object textureId = list.get(0);
      pigeonResult.setTextureId((textureId == null) ? null : ((textureId instanceof Integer) ? (Integer) textureId : (Long) textureId));
      Object brightness = list.get(1);
      pigeonResult.setBrightness((Double) brightness);
      return pigeonResult;
    }
  }
  ...
  public interface AndroidVideoPlayerApi {
    ...
    void setBrightness(@NonNull BrightnessMessage msg);
    ...
    static void setup(@NonNull BinaryMessenger binaryMessenger, @Nullable AndroidVideoPlayerApi api) {
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.AndroidVideoPlayerApi.setBrightness", getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<Object>();
                ArrayList<Object> args = (ArrayList<Object>) message;
                BrightnessMessage msgArg = (BrightnessMessage) args.get(0);
                try {
                  api.setBrightness(msgArg);
                  wrapped.add(0, null);
                }
 catch (Throwable exception) {
                  ArrayList<Object> wrappedError = wrapError(exception);
