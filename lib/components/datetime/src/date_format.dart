...
String formatDate(DateTime? date, List<String> formats, LocaleType locale) {
  ...
  for (String format in formats) {
    if (format == yyyy) {
      ...
      String monthLong =
          (i18nObjInLocale(locale)!['monthLong'] as List)[date!.month - 1];
      sb.write(monthLong);
    } else if (format == M) {
      String monthShort =
          (i18nObjInLocale(locale)!['monthShort'] as List)[date!.month - 1];
      sb.write(monthShort);
    } else if (format == dd) {
      ...
      String day = (i18nObjInLocale(locale)!['day'] as List)[date!.weekday - 1];
      sb.write(day);
    } else if (format == HH) {
