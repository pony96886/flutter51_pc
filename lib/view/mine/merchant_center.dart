...
class MerchantCenter extends StatefulWidget {
  const MerchantCenter({Key? key}) : super(key: key);

  @override
  State<MerchantCenter> createState() => _MerchantCenterState();
}

class _MerchantCenterState extends State<MerchantCenter> {
  @override
        ...
        child: Scaffold(
            ...
            body: CgTabView(
              ...
              pages: [
                ...
                CgTabView(
                    padding:
                        EdgeInsets.only(bottom: 12.w, left: 15.w, right: 15.w),
                    isCenter: false,
                    isFlex: true,
                    type: CgTabType.redRaduis,
                    defaultStyle:
