...
class RecordingPage extends StatefulWidget {
  ...
  RecordingPage({Key? key, this.type}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: PreferredSize(
          child: PageTitleBar(
            title: widget.type == 0 ? chargeStr : txjlstr,
          ),
      ...
      child: Column(
        children: [
          Row(
            ...
            children: [
              Text(
                widget.type == 0 ? oderItem['descp'] : lijis,
              ...
              Row(
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: TextStyle(color: Color(0xff666666), fontSize: 12.w),
                  )
                ],
              ),
              Text(oderItem['created_at'],
                  style: TextStyle(color: Color(0xff999999), fontSize: 12.w)),
            ],
          ),
          SizedBox(
            height: 12.w,
