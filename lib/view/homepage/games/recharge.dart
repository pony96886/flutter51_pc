...
class GameRechargePage extends StatefulWidget {
  GameRechargePage({Key? key}) : super(key: key);

  @override
  _GameRechargePageState createState() => _GameRechargePageState();
}
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              padding: EdgeInsets.only(top: 25.w, bottom: 22.w),
              child: Row(
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () {
                      AppGlobal.appRouter?.push('/gameRecordingPage/0');
                    },
                    child: Row(
