...
class MineMonyDtailPage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => MineMonyDtailPageState();
}

class MineMonyDtailPageState extends State<MineMonyDtailPage> {
  int limit = 30;
                    ...
                    Expanded(
                        child: PublicList(
                            ...
                            itemBuild: (context, index, data, page, limit, getListData) {
                              return _record(data['time'], data['source'], data['coin']);
                            }))
                  ],
                ),
                leftChild: Column(
