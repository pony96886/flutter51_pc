...
class _NaledChatManageState extends State<NaledChatManage> with TickerProviderStateMixin {
              ...
              children: [
                PageTitleBar(
                  ...
                  rightWidget: GestureDetector(
                    onTap: () {
                      AppGlobal.appRouter?.push(CommonUtils.getRealHash('nakechatPublish'));
                    },
                    child: Text(
                      '发布',
                  ...
                  Column(
                    children: [
                      NavTabBarWidget(
                        ...
                        indicator:
                            LineIndicator(isCenter: true, width: 75.w, height: 25.w, color: StyleTheme.cDangerColor),
                      ),
                      Expanded(
                        ...
                        children: [
                          PageViewMixin(
                            child: PublicList(
                                ...
                                row: 1,
                                itemBuild: (context, index, data, page, limit, getListData) {
                                  return NakedChatOrderCard(data: data, type: 2);
                                }),
                          ),
                          PageViewMixin(
                            child: PublicList(
