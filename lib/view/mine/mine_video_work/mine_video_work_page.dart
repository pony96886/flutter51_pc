...
class MineVideoWorkPage extends StatefulWidget {
  const MineVideoWorkPage({Key? key}) : super(key: key);

  @override
  State<MineVideoWorkPage> createState() => _MineVideoWorkPageState();
}

class _MineVideoWorkPageState extends State<MineVideoWorkPage> {
  bool loading = true;
  Map info = {};
  @override
  void initState() {
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                                image: DecorationImage(
                                    fit: BoxFit.cover, image: AssetImage('assets/images/mine/work_bg.png'))),
                            child: Column(
                              children: [
                                Row(
                                  children: [
                                    ClipRRect(
                                      ...
                                      child: LocalPNG(
                                        width: 50.w,
                                        height: 50.w,
                                        url: 'assets/images/common/${members.thumb}.png',
                                      ),
                                    ),
                                    SizedBox(
                                      width: 10.5.w,
                                    ...
                                    Text(
                                      members.nickname!,
                                      style: TextStyle(fontSize: 18.sp, color: StyleTheme.cTitleColor),
                                    )
                                  ],
                                ),
                                SizedBox(
                                      ...
                                      children: [
                                        Column(
                                          children: [
                                            ...
                                            Text('${info['all_original_blogger_money'] ?? 0}'),
                                          ],
                                        ),
                                        Container(
                                          width: 0.5.w,
                                          height: 45.w,
                                          margin: EdgeInsets.symmetric(horizontal: 64.5.w),
                                        ...
                                        Column(
                                          children: [
                                            ...
                                            Text('${info['original_blogger_money' ?? 0]}'),
                                          ],
                                        )
                                      ],
                                    )),
                                ...
                                GestureDetector(
                                  onTap: () {
                                    AppGlobal.appRouter?.push(CommonUtils.getRealHash('withdrawPage/1'));
                                  },
                                  child: Container(
                                    width: 275.w,
                                    height: 50.w,
                                    ...
                                    child: Stack(
                                      children: [
                                        ...
                                        Center(
                                            child:
                                                Text("立即提现", style: TextStyle(color: Colors.white, fontSize: 15.sp))),
                                      ],
                                    ),
                                  ),
                                )
                              ...
                              ? Column(
                                  children: [
                                    Container(
                                      ...
                                      decoration: BoxDecoration(
                                          image: DecorationImage(
                                              fit: BoxFit.fill, image: AssetImage('assets/images/mine/work_bgb.png'))),
                                      child: Row(
                                        ...
                                        children: [
                                          DefaultTextStyle(
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  Text('认证博主发布视频'),
                                                  Text('可获得${info['original_certified_share'] ?? 0}%分成'),
                                                ],
                                              )),
                                          GestureDetector(
                                            onTap: () {
                                              context.push(CommonUtils.getRealHash('upAuth'));
                                            },
                                            child: Container(
                                              ...
                                              child: Text(
                                                '立即认证',
                                                style: TextStyle(color: Color(0XFFd9d9d9), fontSize: 14.sp),
                                              ),
                                            ),
                                          )
                                        ],
                            ...
                            child: Padding(
                                ...
                                child: PublicList(
                                  ...
                                  itemBuild: (context, index, data, page, limit, getListData) {
                                    return TanhuaCard(item: data, isHideShow: true);
                                  },
                                )),
                          ),
                          PageViewMixin(
