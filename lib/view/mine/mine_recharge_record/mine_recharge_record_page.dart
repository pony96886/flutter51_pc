...
class MineRechargeRecordPage extends StatefulWidget {
  final String? type;
  MineRechargeRecordPage({Key? key, this.type}) : super(key: key);

  @override
  State<StatefulWidget> createState() => MineRechargeRecordPageState();
}

class MineRechargeRecordPageState extends State<MineRechargeRecordPage> {
  List<Map>? orderList;
      ...
      child: Column(
        ...
        children: <Widget>[
          Container(
            ...
            decoration: BoxDecoration(border: Border(bottom: BorderSide(width: 0.5.w, color: Color(0xFFEEEEEE)))),
            child: Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: <Widget>[
                Text(
                  '订单ID: ' + item['id'].toString(),
                  style: TextStyle(color: StyleTheme.cTitleColor, fontWeight: FontWeight.w300, fontSize: 12.sp),
                  maxLines: 1,
                ...
                GestureDetector(
                  ...
                  child: Text('复制',
                      style: TextStyle(color: StyleTheme.cDangerColor, fontWeight: FontWeight.bold, fontSize: 15.sp)),
                )
              ],
            ),
          ),
                  ...
                  children: <Widget>[
                    ...
                    Row(
                      ...
                      children: <Widget>[
                        ...
                        GestureDetector(
                          onTap: () {
                            ServiceParmas.orderId = "订单ID:" + item['id'].toString();
                            ServiceParmas.type = 'cz';
                            AppGlobal.appRouter?.push(CommonUtils.getRealHash('onlineServicePage'));
                          },
                          child: Text(
                            '联系客服>',
                            style: TextStyle(color: Color(0xFF8A8BC5), fontWeight: FontWeight.bold, fontSize: 15.sp),
                          ),
                        )
                      ],
                    )
