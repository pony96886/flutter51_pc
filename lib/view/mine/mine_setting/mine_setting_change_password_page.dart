...
class MineSettingChangePasswordPage extends StatefulWidget {
  final bool isSetting;
  MineSettingChangePasswordPage({Key? key, this.isSetting = false}) : super(key: key);

  @override
  _MineSettingChangePasswordPageState createState() => _MineSettingChangePasswordPageState();
}

class _MineSettingChangePasswordPageState extends State<MineSettingChangePasswordPage> {
  ...
  void handleSubmit() async {
    ...
    if (widget.isSetting) {
      ...
      var result = await updatePassword(_basepassword.text, _newpassword.text, _repeatpassword.text);
      BotToast.closeAllLoading();
      if (result!['status'] == 1) {
        showText("更改成功");
        _getNumInfo();
              ...
              child: Column(
                ...
                children: <Widget>[
                  Text(widget.isSetting ? setPasStr : "修改密码",
                      ...
                      style: TextStyle(color: StyleTheme.cTitleColor, fontSize: 24.sp, fontWeight: FontWeight.bold)),
                      ...
                      child: Container(
                          ...
                          child: Stack(
                            children: [
                              ...
                              Center(
                                child: Text(widget.isSetting ? setPasStr : "修改密码",
