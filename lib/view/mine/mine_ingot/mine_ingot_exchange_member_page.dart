...
class MineIngotExchangeMemberPage extends StatefulWidget {
  MineIngotExchangeMemberPage({Key? key}) : super(key: key);

  @override
  State<MineIngotExchangeMemberPage> createState() => _MineIngotExchangeMemberPageState();
}

class _MineIngotExchangeMemberPageState extends State<MineIngotExchangeMemberPage> {
  bool loading = true;
  ...
  Widget build(BuildContext context) {
    return HeaderContainer(
      ...
      appBar: PreferredSize(child: PageTitleBar(title: '兑换会员'), preferredSize: Size(double.infinity, 44.w)),
      body: ListView(
        children: <Widget>[
          Center(
            child: Wrap(
                              ...
                              return index == 0
                                  ? Column(
                                      ...
                                      children: [
                                                      ...
                                                      child: Center(
                                                        child: Row(
                                                          ...
                                                          children: [
                                                            ...
                                                            Text.rich(TextSpan(
                                                                text: double.parse(product['promo_price'])
                                                                    .toStringAsFixed(0),
                                                                style: TextStyle(
                                          ...
                                          rowText(
                                            '元宝优惠券',
                                            coinsValue.isEmpty ? '选择抵用券' : coinsValue.toString() + '元宝抵用券',
                                            setBottomSheetState,
                                            coinsValue.isEmpty ? StyleTheme.cBioColor : StyleTheme.cDangerColor,
                                          ),
                                          BottomLine(),
                                          Center(
                                            child: Text(
                                          ...
                                          Expanded(
                                              child: Center(
                                                  child: GestureDetector(
                                                      onTap: () {
                                                        if (double.parse(money.toString()) <
                                                            (double.parse(product['promo_price'].toString()))) {
                                                          BotToast.showText(text: '元宝不足', align: Alignment(0, 0));
                                                          AppGlobal.appRouter
      ...
      child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                '¥$promoPrice',
                style: TextStyle(color: Color(0xFF505050), fontSize: 24.sp, fontWeight: FontWeight.w500),
              ),
            ],
          )),
    );
