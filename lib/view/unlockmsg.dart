              ...
              children: [
                Row(
                  ...
                  children: [
                    Text(
                      item['nickname'],
                      style: TextStyle(color: StyleTheme.cTitleColor, fontWeight: FontWeight.w500, fontSize: 16.sp),
                    ),
                    Text(
                      item['created_at'] == null ? '' : CommonUtils.getCgTime(int.parse(item['created_at'].toString())),
                      style: TextStyle(color: StyleTheme.cTextColor, fontSize: 12.sp),
                    ),
                  ],
                ),
                Row(
  ...
  Widget getMsgType(List content) {
    return Expanded(
      ...
      TextSpan(
          ...
          style: TextStyle(color: Color(int.parse(content[0]['color'])), fontSize: 14.sp),
          children: [
            content.length > 1
                ? TextSpan(
                    text: content[1]['value'],
                    style: TextStyle(color: Color(int.parse(content[1]['color'])), fontSize: 14.sp),
                  )
                : TextSpan(),
          ]),
      maxLines: 1,
