...
class MineSettingBindPhonePage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => MineSettingBindPhonePageState();
}

class MineSettingBindPhonePageState extends State<MineSettingBindPhonePage> {
  ...
  initInviteCode() {
    var invited = Provider.of<HomeConfig>(context, listen: false).member.invitedBy;
  ...
  Future setLoginData() async {
    ...
    var data = await bindEmail(_phoneNumController.text, _veriCodeController.text);
              ...
              child: Column(
                ...
                children: <Widget>[
                  Text("绑定邮箱",
                      ...
                      style: TextStyle(color: Colors.white, fontSize: 24.w, fontWeight: FontWeight.w500)),
                    ...
                    child: Container(
                      ...
                      child: Stack(
                        children: [
                          ...
                          Center(child: Text("立即绑定", style: TextStyle(color: StyleTheme.cTitleColor, fontSize: 15.sp))),
                        ],
                      ),
                    ),
                  ),
