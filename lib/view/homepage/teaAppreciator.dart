          ...
          child: Column(
            ...
            children: <Widget>[
              Container(
                ...
                child: Text("鉴茶师分为实习和正式两个阶段，每月的考核指标完成了，实习才能转正，如果正式鉴茶师当月未完成考核任务，那么也会由正式转为实习。",
                    style: TextStyle(color: StyleTheme.cTitleColor, fontSize: 13.sp, fontWeight: FontWeight.w500)),
              ),
              Container(
                child: Text("考核标准分为初中高三个级别，考核要求会在鉴茶师群里公布，考核范围如下：",
                    style: TextStyle(color: StyleTheme.cTitleColor, fontSize: 13.w, fontWeight: FontWeight.w500)),
              ),
              Container(
                margin: EdgeInsets.only(bottom: 15.w),
                child: Text("1. 每月提交验茶报告数量\n2. 分享真实资源或推广经纪人/茶女郎入驻的数量\n3. 完成平台发布任务数量",
                    style: TextStyle(color: StyleTheme.cDangerColor, fontSize: 13.sp, height: 1.5)),
              ),
              Container(
                margin: EdgeInsets.only(bottom: 15.w),
                        ...
                        child: SizedBox(
                          ...
                          child: Stack(
                            children: [
                              ...
                              Center(
                                child: Text("申请认证", style: TextStyle(color: Colors.white, fontSize: 16.sp)),
                              ),
                            ],
                          ),
                        ),
