...
class MyTeaPost extends StatefulWidget {
  MyTeaPost({Key? key, this.initTab}) : super(key: key);
  final int? initTab;
  @override
  _MyTeaPostState createState() => _MyTeaPostState();
}

class _MyTeaPostState extends State<MyTeaPost> with TickerProviderStateMixin {
  ...
  _getNumInfo() async {
    ...
    Provider.of<HomeConfig>(context, listen: false)
        .setCoins(_number['data']['coin']);
    Provider.of<HomeConfig>(context, listen: false)
        .setMoney(_number['data']['money']);
    Provider.of<HomeConfig>(context, listen: false)
        .setAgent(_number['data']['agent']);
  }
  ...
  void initState() {
    ...
    tabController = new TabController(
        vsync: this, length: tabs.length, initialIndex: tabsIndex);
