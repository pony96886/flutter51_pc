...
class MineElegantCollect extends StatefulWidget {
  MineElegantCollect({Key? key}) : super(key: key);

  @override
  _MineElegantCollectState createState() => _MineElegantCollectState();
}

class _MineElegantCollectState extends State<MineElegantCollect> with SingleTickerProviderStateMixin {
            ...
            children: [
              TabBar(
                  ...
                  tabs: _tabs
                      .asMap()
                      .keys
                      .map((key) => CustomTab(tabIndex: _selectedTabIndex, keyIndex: key, title: _tabs[key]['title']))
                      .toList()),
              Expanded(
