...
class SelectMultipleCoupon extends StatefulWidget {
  final List? isSelect;
  final Function? setCallBack;
  SelectMultipleCoupon({Key? key, this.isSelect, this.setCallBack})
      : super(key: key);

  @override
  _SelectMultipleCouponState createState() => _SelectMultipleCouponState();
}

class _SelectMultipleCouponState extends State<SelectMultipleCoupon> {
  Map cardData = {
    'data': null,
    'id': 0,
    'page': 1,
  ...
  getUserCouponList() async {
    ...
    CommonUtils.debugPrint(myCoupon);
  ...
  List matchObjectsById(List idList, List objectList) {
    List matchedObjects = [];
        ...
        : Expanded(
            ...
            children: [
              cardData['data'].length == 0 ||
                      cardData['data'].length == 1 &&
                          cardData['data'][0]['value'] == 0
                  ? Container(
                            ...
                            return GestureDetector(
                              ...
                              child: YouHuiQuanCard(
                                  ...
                                  isSelect: widget.isSelect!
                                      .contains(cardData['data'][index]['id']),
